...
import com.example.ukkcong.adapter.ItemAdapter
import com.example.ukkcong.userdatabase.CafeDatabase
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        addButton.setOnClickListener{
            val moveIntent = Intent(this@MainActivity, AddItemActivity::class.java)
            startActivity(moveIntent)
        }
        mejaButton.setOnClickListener{
            val moveIntent = Intent(this@MainActivity, ListMejaActivity::class.java)
            startActivity(moveIntent)
        }
        ...
        checkoutButton.setOnClickListener{
            val moveIntent = Intent(this@MainActivity, CartActivity::class.java)
